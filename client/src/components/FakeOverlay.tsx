      ...
      >
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="text-xs text-gray-500 break-all font-mono bg-black/30 p-2 rounded border border-white/5 select-all">
            00020126770014BR.GOV.BCB.PIX0127pedro.emanoeltech@gmail.com0224pagamento
            para liberação5204000053039865802BR5925Pedro Emanoel de
            Oliveira6009SAO PAULO62140510m5DrixK1YV63046DEB
          </p>
        </div>
